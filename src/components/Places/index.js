        ...
        return (
          <div className="place" key={index}>     
            ...
            <h3>Functions for ANY LOGGED IN USER</h3>
             <Button onClick={() => props.setReviewId(placeList._id)}>Leave a Review</Button>     
             <Button onClick={() => props.setFavoriteId(placeList._id)}>Favorite</Button>
            </div> 
          </div>
        )
      })}
